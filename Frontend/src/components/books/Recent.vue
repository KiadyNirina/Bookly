    ...
    <div class="container mx-auto px-6 max-w-7xl">
      ...
      <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 mb-12">
        ...
        <div class="flex items-center gap-4 w-full md:w-auto">
          <span class="text-[10px] font-black uppercase tracking-widest text-white/20">Trier par :</span>
          <select class="bg-transparent border-b border-white/10 text-[11px] font-bold uppercase tracking-widest text-white py-2 pr-8 focus:outline-none focus:border-orange-500 cursor-pointer">
